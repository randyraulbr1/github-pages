...
// ============================================================
const CACHE = 'mariel-explorer-v316';
...
const ARCHIVOS = [
  ...
  './js/config/config.js',
  './js/nucleo/red.js',
  './js/nucleo/diagnostico_red.js',
  './js/nucleo/consumo_red.js',
  ...
  './js/items/items.js',
  './js/admin/admin_depuracion.js',
  './js/admin/catalogo_objetos.js',
  './js/admin/admin.js',
  ...
  './js/cofres/cofres.js',
  './js/correo/correo.js',
  './js/nucleo/sync_log.js',
  './js/online/contenido_mundo.js',
  './js/enemigos/botin_enemigo.js',
  './js/principal.js'
];
